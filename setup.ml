...
(* OASIS_START *)
(* DO NOT EDIT (digest: b5bb4e8facc0aeb7d573d3c295321f4d) *)
(*
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("LD_LIBRARY_PATH=_build", ["$test"; "zlib_stubs.c"]))
                   ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\019R\133\222\165\196\228,[\146\1602\023\189d\147";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
