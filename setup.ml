...
(* OASIS_START *)
(* DO NOT EDIT (digest: efd0c6137168b9c1b1a4b0a8b3c84877) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-classic-display"];
     test =
       [
          ("zlib",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test", ["zlib_stubs.c"]))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/madroach/ocaml-zlib";
          synopsis = "Bindings to zlib, a deflate compression library";
          description =
            Some
              [
                 OASISText.Para
                   "zlib provides deflate compression, optionally wrapped in gzip or zlib format."
              ];
          categories = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/madroach/ocaml-zlib.git";
                      src_repo_browser =
                        Some "https://github.com/madroach/ocaml-zlib";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lz"])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Zlib";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "N4{h\220\134\163\146\251lrC\006\019\211\216";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
